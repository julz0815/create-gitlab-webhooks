...
const axios_1 = __importDefault(__nccwpck_require__(126));
...
function getProjectId(projectPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield api.get(`/projects/${encodeURIComponent(projectPath)}`);
            if (DEBUG) {
...
function createWebhook(groupPath, repoName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const projectId = yield getProjectId(projectPath);
            if (DEBUG) {
            ...
            const response = yield api.get(`/projects/${projectId}/hooks`);
            if (DEBUG) {
                console.log(response);
            }
            ...
            if (existingWebhook) {
                ...
                const deleteResponse = yield api.delete(`/projects/${projectId}/hooks/${existingWebhook.id}`);
                if (DEBUG) {
            ...
            const createResponse = yield api.post(`/projects/${projectId}/hooks`, webhookConfig);
            if (DEBUG) {
...
function getAllGroupRepositories(groupPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            while (true) {
                const response = yield api.get(`/groups/${encodeURIComponent(groupPath)}/projects`, {
                    params: {
                        page,
                        per_page: perPage,
            ...
            const repositories = allProjects.map((project) => {
